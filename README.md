This project is mostly for me to become familiar with using OpenAI APIs to send and receive prompts to ChatGPT, as well as running a webserver using fastAPI.
